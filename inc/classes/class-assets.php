...
class Assets {
    ...
    public function register_styles() {
        ...
        wp_register_style(
            ...
            [],
            filemtime( AQUILA_DIR_PATH . '/assets/src/library/css/bootstrap.min.css'),
            'all'
        );
    ...
    public function register_scripts() {
        ...
        wp_register_script(
            'bootstrap-js',
            AQUILA_DIR_URI . '/assets/src/library/js/bootstrap.min.js',
            [ 'jquery' ],
            filemtime( AQUILA_DIR_PATH . '/assets/src/library/js/bootstrap.min.js'),
            true
        );
